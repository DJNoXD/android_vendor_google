...
PRODUCT_COPY_FILES += \
	vendor/google/armv6/lib/libvideochat_jni.so:system/lib/libvideochat_jni.so \
...
$(shell rm -f $(OUT)/system/app/SetupWizard.ap)
...
$(shell rm -f $(OUT)/system/lib/libvideochat_jni.so)
